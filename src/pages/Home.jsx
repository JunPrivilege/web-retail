...
function HomePage() {
  ...
  return (
    <>
      <main className="homepage min-h-screen min-w-screen">
        <div className="card flex justify-end items-center h-96 w-full mt-2">
          <div className="rounded-lg shadow-lg flex max-w-lg mx-20 media">
            <div className="p-8 bg-gray-500 flex flex-col justify-center w-full">
              <h2 className="text-3xl font-bold mb-4 text-white line-clamp-2">
                New Generation Ceramic Tile
              </h2>
              <p className="text-white font-thin mb-6 line-clamp-4">
        ...
        <div className="px-32 pt-5 pb-28 content">
          <HomeProducts />
